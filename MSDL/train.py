...
def main():
    ...
    if args.data_type == 'icetype':
        args.num_classes = 11
    elif args.data_type == 'icecon':
        args.num_classes = 12
    ...
    for epoch in range(start_epoch, args.stop_epoch + 1):
        ...
        F1_score, F1_score_micro_average, F1_score_macro_average, outputs = validate(val_loader, net, criterion, epoch,
                                                                                     logger, args)
...
def validate(val_loader, net, criterion, epoch, logger, args):
    ...
    F1_score_micro_average = evaluator.F1_Score(method='micro_average')
    F1_score_macro_average = evaluator.F1_Score(method='macro_average')
    ...
    outputs = [
        "val e: {}".format(epoch),
        'micro_average: {:.4f}'.format(F1_score_micro_average),
        'macro_average: {:.4f}'.format(F1_score_macro_average),
        'loss: {:.4f}'.format(loss),
    ]

    return F1_score, F1_score_micro_average, F1_score_macro_average, outputs
