...
def WMO_ice_chart_color_code():
    # open water, new ice, gray ice, gray-white ice, thin first-year ice, medium first-year ice,
    # thick first-year ice, old ice, second-year ice, multi-year ice
    colorlist = [(  0 / 255, 100 / 255, 255 / 255),
                 (240 / 255, 210 / 255, 250 / 255),
                 (135 / 255,  60 / 255, 215 / 255),
                 (220 / 255,  80 / 255, 235 / 255),
                 (155 / 255, 210 / 255,   0 / 255),
                 (  0 / 255, 200 / 255,  20 / 255),
                 (  0 / 255, 120 / 255,   0 / 255),
                 (180 / 255, 100 / 255,  50 / 255),
                 (255 / 255, 120 / 255, 10 / 255),
                 (200 / 255,   0 / 255,  0 / 255)
                 ]
    cmap = matplotlib.colors.ListedColormap(colorlist, N=10)
...
if __name__ == "__main__":
    ...
    plt.figure()
    plt.scatter(range(10), range(10), c=range(10), cmap=WMO_ice_chart_color_code())
    plt.show()
